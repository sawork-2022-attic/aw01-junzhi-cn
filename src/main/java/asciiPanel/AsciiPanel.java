...
public class AsciiPanel extends JPanel {
     ...
     * This should be equal to or greater than 0 and less than the the width in
     * characters.
     * 
     ...
     * This should be equal to or greater than 0 and less than the the height in
     * characters.
     * 
     ...
     * The x should be equal to or greater than 0 and less than the the width in
     * characters.
     * The y should be equal to or greater than 0 and less than the the height in
     * characters.
     * 
     ...
     * properly sized after setting the font
     ...
     * background colors.
     * This updates the cursor's position but not the default foreground or
     * background colors.
     * 
     * @param character  the character to write
     * @param foreground the foreground color or null to use the default
